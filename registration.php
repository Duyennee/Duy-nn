...
if (isset($_POST['form1'])) {
    ...
    if(empty($_POST['cust_name'])) {
        $valid = 0;
        $error_message .= 'Lỗi tên'."<br>";
    }

    if(empty($_POST['cust_email'])) {
        $valid = 0;
        $error_message .= 'Lỗi email'."<br>";
    } else {
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for=""><?php echo 'Tiểu bang'; ?> *</label>
                                ...
                                <div class="col-md-6 form-group">
                                    <label for=""></label>
                                    <input type="submit" class="btn btn-danger" value="<?php echo 'Đăg ký'; ?>" name="form1">
                                </div>
                            </div>
                        </div>                        
                    </form>
